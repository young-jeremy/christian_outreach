...
urlpatterns = [
    ...
    path('admin/password_reset_complete/', auth_views.PasswordResetCompleteView.as_view(), name='password_reset_complete'),
    path('users/', include('users.urls')),
    path('', include('videos.urls')),
    path('api-auth/', include('rest_framework.urls')),
    path('api-auth/', include('drf_social_oauth2.urls', namespace='drf')),
    path('reset/', include('django.contrib.auth.urls'), name='reset'),
